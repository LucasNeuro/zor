...
-- Usado em /crm/conhecimento e sugestão de cargos com contexto do negócio.
...
COMMENT ON TABLE public.hub_tenant_conhecimento_chunk IS 'Chunks com embedding mistral-embed (1024 dimensões) para RAG tenant.';
COMMENT ON FUNCTION public.match_hub_tenant_conhecimento_chunks IS 'Busca semântica por tenant usando cosine distance em pgvector.';
