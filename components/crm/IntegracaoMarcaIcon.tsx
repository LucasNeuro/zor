 ...
 */
export type IntegracaoMarcaIconVariant =
  | "whatsapp"
  | "google"
  | "google-calendar"
  | "gmail"
...
export function IntegracaoMarcaIcon({
  ...
  if (variant === "supabase") {
    return (
      // eslint-disable-next-line @next/next/no-img-element -- logótipo oficial Supabase (SVG marca)
      <img
        src="/brands/supabase-logo-icon.svg"
        alt={label}
        width={size}
        height={size}
        style={{ display: "block", objectFit: "contain" }}
