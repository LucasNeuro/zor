-- FTS para harness_session_search (RFC Fase 5)
...
COMMENT ON FUNCTION public.hub_briefing_mensagem_search IS
  'FTS de mensagens briefing por agente — harness_session_search.';
