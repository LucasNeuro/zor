...
/** Grupo segmentado escuro — padrão drawer de cargos / tabela Conta. */
...
export function CrmSideoverTabGroup<T extends string>({
  ...
  return (
    <CrmSideoverActionScrollRow label="Conteúdo">
      <CrmSideoverActionGroup className="w-full min-w-max">
        {tabs.map((t) => (
...
/** Painel interno escuro para formulários (substitui CadastroSideoverPanel em leads). */
export function CrmSideoverFormPanel({
  ...
  return (
    <div
      ...
      style={{ borderColor: RF_BORDER, background: "rgba(6, 13, 8, 0.45)" }}
    >
      <div className="border-b px-4 py-3" style={{ borderColor: RF_BORDER }}>
        <p className="m-0 text-[11px] font-bold uppercase tracking-wide" style={{ color: RF_ACCENT }}>
          {title}
        </p>
      </div>
