...
-- Console operacional Waje: role platform_admin + mensalidades por tenant.
-- Idempotente â€” seguro em produÃ§Ã£o. Cole no SQL Editor do Supabase.

-- â”€â”€â”€ 1) Papel platform_admin â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
DO $$
BEGIN
  IF NOT EXISTS (
...
-- â”€â”€â”€ 2) Mensalidades SaaS por tenant â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€â”€ 3) Promover utilizador Waje (ajuste e-mail) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
-- UPDATE public.users SET role = 'platform_admin', tenant_id = NULL
-- WHERE lower(trim(email)) = 'seu-email@waje.com.br';
-- Acesso operacional Waje (/ops) via coluna owner em public.users
-- Idempotente â€” cole no SQL Editor do Supabase

ALTER TABLE public.users
  ADD COLUMN IF NOT EXISTS owner BOOLEAN NOT NULL DEFAULT false;

COMMENT ON COLUMN public.users.owner IS
  'Equipe Waje com acesso ao console operacional (/ops). NÃ£o confundir com dono do tenant CRM.';
