-- Configuração de agenda Google Calendar por tenant (Waje multi-empresa)
...
COMMENT ON TABLE public.hub_tenant_agenda_config IS
  'Horário de funcionamento e duração de reservas Google Calendar por empresa (tenant).';
