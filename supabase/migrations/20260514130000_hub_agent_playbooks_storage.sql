...
COMMENT ON COLUMN public.hub_agente_identidade.playbook_generated_at IS 'Última geração do playbook.';
COMMENT ON COLUMN public.hub_agente_identidade.playbook_source_hash IS 'SHA-256 do snapshot canónico usado na última geração.';
